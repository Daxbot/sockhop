 ...
 *   - ERR_RESPONSE_ABANDONED : the response was abandoned, usually becuase the requester called disconnected
 *   - ERR_RESPONSE_REPEAT : the requestee attempted to `respond` twice
 *
 * @extends Error
 */
