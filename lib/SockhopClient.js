...
class SockhopClient extends EventEmitter{
    ...
    constructor(opts={}){
        ...
        this._handshake_resolved = false;
    ...
    _on_recieved_object(o) {
        ...
        case "SockhopHandshake":
            ...
            this.emit("_handshake", o.data);
            this._trigger_remote_callback(o.id, { /* TODO */});
            break;
        case "SockhopPing":
