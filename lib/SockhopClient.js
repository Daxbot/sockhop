...
class SockhopClient extends EventEmitter{
    ...
    constructor(opts={}){
        ...
        this.set_auto_reconnect_state(false);
    ...
    get auto_reconnect_active(){
        ...
        return this._auto_reconnect_active;
    }
     ...
     */
    get auto_reconnect(){
        return deprecate(() => this._auto_reconnect_active, "Using the auto_reconnect getter has been deprecated. Please use auto_reconnect_active.")();
    }
    ...
    set auto_reconnect(b){
        deprecate(() => this.set_auto_reconnect_state(b), "Using the auto_reconnect setter has been deprecated. Please use either `.connect({ auto_reconenct:true })` or `.start()`. Of if you must, use `.set_auto_reconnect_state(...)`")();
    }
     ...
     * @param {boolean}
     */
    set_auto_reconnect_state(auto_reconnect) {

        this._auto_reconnect_active=!!auto_reconnect;

        if ( this._auto_reconnect_active && this._auto_reconnect_timer == null ) {
        ...
        if ( !this._auto_reconnect_active ) {
            clearInterval(this._auto_reconnect_timer);
            this._auto_reconnect_timer = null;
        }
     ...
     */
    async start(){
        this.set_auto_reconnect_state(true);
     ...
     */
    async connect({ auto_reconnect }={}){
        return this._connect().then(() => {
            if ( auto_reconnect !== undefined ) this.set_auto_reconnect_state(auto_reconnect);
            return this;
        });
    }
        ...
        return new Promise((resolve, reject)=>{
            ...
            socket
                ...
                .on("error",(e)=>{
                    ...
                    } else if(e.toString().match(/This socket is closed/) && this.auto_reconnect_active===true) {
                    ...
                    } else if( e.toString().match(/ECONNREFUSED/) && (this.auto_reconnect_active || this._connecting)) {
