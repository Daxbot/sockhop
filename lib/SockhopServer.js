...
class SockhopServer extends EventEmitter {
    ...
    send(sock,o, callback){
        ...
        // Sanity checks
        if(!sock) throw new SockhopError("SockhopServer send() requires a socket", "ERR_NO_SOCKET");
        ...
        return new Promise(res => sock.write(this._encoding_objectbuffer.obj2buf(m), res));
    }
