...
<li>ERR_RESPONSE_ABANDONED : the response was abandoned, usually becuase the requester called disconnected</li>
<li>ERR_RESPONSE_REPEAT : the requestee attempted to <code>respond</code> twice</li>
</ul>
</dd>
...
connection, and for them to generate and return a response.</p>
...
attributes. And then <code>.respond(...)</code> a response</p>
</dd>
...
<dl>
<dt><a href="#SockhopResponse">SockhopResponse</a> : <code>object</code></dt>
<dd></dd>
...
* [SockhopClient](#SockhopClient) ⇐ <code>EventEmitter</code>
    ...
    * [.send(object, [rcallback], [config])](#SockhopClient+send) ⇒ <code>Promise</code>
    * [.request(object, config)](#SockhopClient+request) ⇒ [<code>Promise.&lt;SockhopResponse&gt;</code>](#SockhopResponse)
    ...
    * ["request" (req)](#SockhopClient+event_request)
...
| [opts.response_timeout] | <code>number</code> | <code></code> | the length of time in ms that the callback map should hold values by default. Set `null` to use no timeouts (note this is a memory leak hazard). |
...
### sockhopClient.send(object, [rcallback], [config]) ⇒ <code>Promise</code>
Send
...
| [config] | <code>object</code> |  |
| [config.error_cb] | <code>function</code> | Optional callback to handle unintended drops on the response handler (i.e. the response took too long, and the internal map of response handlers dropped the reference) |
| [config.timeout] | <code>number</code> | Optional timeout override for how long we should hold the callback function for |

<a name="SockhopClient+request"></a>

### sockhopClient.request(object, config) ⇒ [<code>Promise.&lt;SockhopResponse&gt;</code>](#SockhopResponse)
Make a request
...
- [<code>SockhopError</code>](#SockhopError) If the send is unsuccessful, or the callback is dropped (i.e. a timeout)
...
| object | <code>object</code> | to be sent over the wire |
| config | <code>object</code> |  |
| [config.timeout] | <code>number</code> | Optional timeout override for how long we should wait for a response |
...
* [SockhopRequest](#SockhopRequest)
    * [new SockhopRequest([opts], [send_cb])](#new_SockhopRequest_new)
    * _instance_
        * [.respond(obj)](#SockhopRequest+respond) ⇒ <code>Promise</code>
    * _static_
        * [.parse(data, [send_cb])](#SockhopRequest.parse) ⇒ [<code>SockhopRequest</code>](#SockhopRequest)
        * [.from_object(obj)](#SockhopRequest.from_object) ⇒ [<code>SockhopRequest</code>](#SockhopRequest)

<a name="new_SockhopRequest_new"></a>

### new SockhopRequest([opts], [send_cb])
Constructor
...
| [send_cb] | <code>function</code> |  | A callback function used internally to respond to this request |

<a name="SockhopRequest+respond"></a>

### sockhopRequest.respond(obj) ⇒ <code>Promise</code>
Send a object as a response to this request

**Kind**: instance method of [<code>SockhopRequest</code>](#SockhopRequest)  
**Returns**: <code>Promise</code> - resolves on send  
**Throws**:

- [<code>SockhopError</code>](#SockhopError) if the send fails


| Param | Type | Description |
| --- | --- | --- |
| obj | <code>\*</code> | the response object |

<a name="SockhopRequest.parse"></a>

### SockhopRequest.parse(data, [send_cb]) ⇒ [<code>SockhopRequest</code>](#SockhopRequest)
...
| Param | Type | Description |
| --- | --- | --- |
| data | <code>\*</code> | the serialized request object |
| [send_cb] | <code>function</code> | A callback function used internally to respond to this request |

<a name="SockhopRequest.from_object"></a>

### SockhopRequest.from\_object(obj) ⇒ [<code>SockhopRequest</code>](#SockhopRequest)
...
| Param | Type | Description |
| --- | --- | --- |
| obj | <code>object</code> | the object to be included as a payload |
...
* [SockhopServer](#SockhopServer) ⇐ <code>EventEmitter</code>
    ...
    * [.request(sock, object, config)](#SockhopServer+request) ⇒ [<code>Promise.&lt;SockhopResponse&gt;</code>](#SockhopResponse)
    ...
    * ["request" (req, meta)](#SockhopServer+event_request)
...
### sockhopServer.request(sock, object, config) ⇒ [<code>Promise.&lt;SockhopResponse&gt;</code>](#SockhopResponse)
Make a request
...
### sockhopSession.request(obj, config) ⇒ [<code>Promise.&lt;SockhopResponse&gt;</code>](#SockhopResponse)
Send a request over this session

**Kind**: instance method of [<code>SockhopSession</code>](#SockhopSession)  
**Returns**: [<code>Promise.&lt;SockhopResponse&gt;</code>](#SockhopResponse) - resolves to peer response  
**Throws**:
...
| --- | --- | --- |
| [opts] | <code>object</code> | an object containing configuration options |
| [opts.timeout] | <code>number</code> | the length of time in ms that this map should hold values by default, set to `null` for no timeout (note, this is memory-leak hazard). |
...
| [timeout] | <code>number</code> | set to `null` to set no timeout, set to `undefined` for default time |

<a name="TimedMap+extract"></a>

### timedMap.extract(key)
...
**Kind**: instance method of [<code>TimedMap</code>](#TimedMap)  
<a name="SockhopResponse"></a>

## SockhopResponse : <code>object</code>
**Kind**: global typedef  
**Properties**

| Name | Type | Description |
| --- | --- | --- |
| data | <code>\*</code> | the (serialized) content of the response |
| type | <code>string</code> | the type (usually constructor.name) of the serialized object |
