...
class SockhopSession extends EventEmitter {
     ...
     * @deprecated
     */
    get sock () { return deprecate(() => this._sock, "Session variable `.sock` has been deprecated, please use `.socket`")(); }
    ...
    _send_message(message) {
        return this.server._send_message(this.socket, message);
    }
     ...
     */
    send(obj) {
        return this.server.send(this.socket, obj);
    }
     ...
     * @param {object} config
     * @throws {SockhopError}
     * @returns {Promise<SockhopResponse>} resolves to peer response
     */
    request(obj, config) {
        return this.server.request(this.socket, obj, config);
    }
     ...
     */
    kill() {
        return this.server.kill_socket(this.socket);
    }
