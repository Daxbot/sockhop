    ...
    buf2obj(buf, {return_buffers=false}={}) {
        ...
        while(end>-1) {
            ...
            try {
                ...
                objects.push({
                    value: JSON.parse(this._buffer.toString('utf8',start,end)),
                    buffer: return_buffers ? this._buffer.slice(start, end) : undefined
                });
                ...
                if(this._allow_non_objects) {
                    ...
                    objects.push({
                        value: this._buffer.toString('utf8',start,end),
                        buffer: return_buffers ? this._buffer.slice(start, end) : undefined
                    });
