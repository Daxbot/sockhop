...
class ObjectBuffer extends EventEmitter{
    ...
    constructor(opts={}){
        ...
        super();
        this._buffer=null;
        this._reserved_msg_offset = 60; // reserve messagse 0-59 for system use
        this._next_msg_id = this._reserved_msg_offset;
        ...
        this._external_msg_unsafe = opts.unsafe || false;
    }
    ...
    add_rx_schema(name, schema, { msg_id }={}) {
        ...
        if (msg_id==null) msg_id = this._next_msg_id++;
    ...
    obj2buf(name, obj){
        ...
        try {
            ...
            schema.schema.encode(obj, buffer, 4 + 2, { unsafe: this._external_msg_unsafe || schema.msg_id < this._reserved_msg_offset } );
            return buffer;
        } catch(e) {
